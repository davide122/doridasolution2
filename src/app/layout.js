...
export const metadata = {
  ...
  description:
    "Dorida Solution offre servizi professionali di marketing digitale, sviluppo web, SEO, gestione dei social media, pubblicità online, analisi dei dati, e sicurezza informatica. Scopri come possiamo trasformare la tua presenza digitale.",
  keywords:
